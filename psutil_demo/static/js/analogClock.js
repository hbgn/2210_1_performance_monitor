...
function AnalogClock(id, option) {
    ...
    var dateTimeFormat = function (time) {
        ...
        str += time.getMonth() + 1 + "-";
        str += time.getDate() + '</span><span style="display: block;margin: -30px; font-size: 6px">';
        str += time.getHours() + ":";
        str += M + ":";
        str += time.getSeconds() + '</span>';
        return str;
    };
    ...
    label.style.fontSize = this.width / 150 + "px";
    label.style.marginTop = this.width * 0.5 + "px";
